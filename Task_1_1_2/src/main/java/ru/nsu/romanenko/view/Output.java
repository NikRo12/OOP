...
public class Output {
    ...
    public static void printInfo(String user_inform, String dealer_inform) {
        System.out.println("\t" + Localization.get("your_cards") + " " + user_inform);
        System.out.println("\t" + Localization.get("dealer_cards") + " " + dealer_inform);
    }

    public static void printStart(String user_inform, String dealer_inform) {
        System.out.println(Localization.get("dealer_puts"));
        printInfo(user_inform, dealer_inform);
        System.out.println(Localization.get("your_move"));
        System.out.println("-----------");
    }

    public static void printDealerMove(String user_inform, String dealer_inform) {
