...
public class PositionTest {
    ...
    void notEqualsDifferentX() {
        assertNotEquals(new Position(3, 4),
                new Position(5, 4));
    }
    ...
    void hashCodeConsistent() {
        assertEquals(new Position(3, 4).hashCode(),
                new Position(3, 4).hashCode());
    }

    @Test
    void hashCodeDiffersForDifferentPositions() {
        assertNotEquals(new Position(1, 2).hashCode(),
                new Position(2, 1).hashCode());
    }

    @Test
    void getters() {
        Position p = new Position(7, 11);
        assertEquals(7, p.horizontal());
        assertEquals(11, p.vertical());
    }
